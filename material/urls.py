...
urlpatterns = [
    ...
    path('inbound/manual/cancel-bulk/', views.bulk_cancel_manual_incoming, name='bulk_cancel_manual_incoming'),
    ...
    path('bom/calculate/group-export/', views.bom_group_export, name='bom_group_export'),
    ...
    path('stock/production-lot-item/', views.production_lot_item_list, name='production_lot_item_list'),
    ...
    path('api/mold/mt/log/<int:log_id>/delete/', views.mold_mt_log_delete, name='mold_mt_log_delete'),
    path('api/mold/mt/<int:pk>/full-resync/', views.mold_mt_full_resync, name='mold_mt_full_resync'),
